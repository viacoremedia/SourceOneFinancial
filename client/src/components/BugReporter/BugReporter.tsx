 ...
 */
export interface BugReporterProps extends Partial<BugReporterConfig> {
  mode?: 'floating' | 'header';
  className?: string;
  style?: React.CSSProperties;
}

export function BugReporter({ systemName, apiUrl, user, contact, mode = 'floating', className, style }: BugReporterProps = {}) {
